...
class RouterSwitchAccessory {
  ...
  getService() {
    ...
    if (this.accessory.context.config.options) {
      ...
      const characteristics = Object.keys(this.accessory.context.config.options).filter(
        (extra) => validChars.includes(extra) && this.accessory.context.config.options[extra] === 'characteristic'
      );
      ...
      if (characteristics.includes('wifi_2ghz')) {
        ...
        if (
          ...
          !this.accessory.context.polling.exclude.includes('wifi_2ghz') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.WifiTwo,
                'wifi_2ghz',
                false
              )
            );
      ...
      if (characteristics.includes('wifi_5ghz')) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('wifi_5ghz') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.WifiFive,
                'wifi_5ghz',
                false
              )
            );
      ...
      if (characteristics.includes('wifi_guest')) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('wifi_guest') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.WifiGuest,
                'wifi_guest',
                false
              )
            );
      ...
      if (characteristics.includes('wps')) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('wps') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.WifiWPS,
                'wps',
                false
              )
            );
      ...
      if (characteristics.includes('dect') && this.accessory.context.config.master) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('dect') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.DECT,
                'dect',
                false
              )
            );
      ...
      if (characteristics.includes('aw') && this.accessory.context.config.master) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('aw') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.AnsweringMachine,
                'aw',
                false
              )
            );
      ...
      if (characteristics.includes('deflection') && this.accessory.context.config.master) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('deflection') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.Deflection,
                'deflection',
                false
              )
            );
      ...
      if (characteristics.includes('led')) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('led') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.DeviceLED,
                'led',
                false
              )
            );
      ...
      if (characteristics.includes('lock')) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('lock') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.DeviceLock,
                'lock',
                false
              )
            );
        ...
        service
          ...
          .on(
            ...
            this.handler.get.bind(
              ...
              this.accessory,
              this.api.hap.Service.Switch,
              this.api.hap.Characteristic.Download,
              'broadband',
              'dl'
            )
          );
    ...
    if (this.extras && this.accessory.context.config.master) {
        ...
        service
          ...
          .on(
            ...
            this.handler.get.bind(
              ...
              this.accessory,
              this.api.hap.Service.Switch,
              this.api.hap.Characteristic.DialAlarm,
              'alarm',
              this.extras.alarm
            )
          )
        ...
        service
          ...
          .on(
            ...
            this.handler.get.bind(
              ...
              this.accessory,
              this.api.hap.Service.Switch,
              this.api.hap.Characteristic.WakeUp,
              'wakeup',
              this.extras.wakeup
            )
          )
      ...
      if (characteristics.includes('ringlock') && this.extras.ringlock.DECTphones) {
        ...
        if (
          this.accessory.context.polling.timer &&
          !this.accessory.context.polling.exclude.includes('ringlock') &&
          !this.accessory.context.polling.exclude.includes('extra')
        ) {
          service
            ...
            .on(
              ...
              this.handler.set.bind(
                ...
                this.accessory,
                this.api.hap.Service.Switch,
                this.api.hap.Characteristic.RingLock,
                'ringlock',
                this.extras.ringlock
              )
            );
        } else {
          service
        ...
        service
          ...
          .on(
            ...
            this.handler.get.bind(
              ...
              this.accessory,
              this.api.hap.Service.Switch,
              this.api.hap.Characteristic.PhoneBook,
              'phoneBook',
              this.extras.phoneBook
            )
          )
          .on(
            'set',

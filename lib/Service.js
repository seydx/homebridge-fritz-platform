...
class Service{
  ...
  async _parseSCPD(){
    ...
    debug('[TR064 Debug] ' + this.device.deviceInfo.friendlyName + ' api request: get ' + this.deviceInfo.SCPDURL);
    ...
    return new Promise((resolve, reject) => {
      ...
      axios(url)
        .then(response => {
          ...
          debug('[TR064 Debug] ' + this.device.deviceInfo.friendlyName + ' api request: Ok');
          ...
          debug('[TR064 Debug] ' + this.device.deviceInfo.friendlyName + ' api request: Error');
